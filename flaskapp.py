...
def responsePage(firstname, lastname, email, count):
    return """ User First Name :  """ + str(firstname) + """ <br> User Last Name : """ + str(lastname) + """ <br>User Email : """ + str(email) + """ <br> Word Count in given file : """ + str(count) + """ <br><br> <a href="/download" >Download</a> """
